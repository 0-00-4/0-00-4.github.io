...
var Terminal = Terminal || function(cmdLineContainer, outputContainer) {
  ...
  return {
    init: function() {
      output('<img align="left" src="http://www.w3.org/html/logo/downloads/HTML5_Badge_128.png" width="100" height="100" style="padding: 0px 10px 20px 0px"><h2 style="letter-spacing: 4px">Web Terminal</h2><p>' + new Date() + '</p><p>введите "help" </p>');
    },
    output: output
  }
};
